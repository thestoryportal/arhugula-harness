...
description: Use when implementing or consuming Phase 7 atomic units and axis-stream clusters.
---

# Canonical Claude Workflow Bridge

Read `.claude/skills/phase-7-implementation/SKILL.md` completely from the workspace root before acting, including every reference it routes for the task. That canonical skill body is the full workflow; this Codex entrypoint does not summarize, trim, or replace it. Resolve its relative references from the canonical skill directory.
