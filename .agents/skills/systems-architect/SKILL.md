...
description: Use when producing architecture recommendations, ADD consolidation, or resolving an execution-time architectural tension.
---

# Canonical Claude Workflow Bridge

Read `.claude/skills/systems-architect/SKILL.md` completely from the workspace root before acting, including every reference it routes for the task. That canonical skill body is the full workflow; this Codex entrypoint does not summarize, trim, or replace it. Resolve its relative references from the canonical skill directory.
