---
name: bmad-prfaq
description: Use when the user asks to create a PRFAQ, work backwards, or challenge a product concept.
---

# Canonical Claude Workflow Bridge

Read `.claude/skills/bmad-prfaq/SKILL.md` completely from the workspace root before acting, including every reference it routes for the task. That canonical skill body is the full workflow; this Codex entrypoint does not summarize, trim, or replace it. Resolve its relative references from the canonical skill directory.
