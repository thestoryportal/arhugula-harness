...
description: Use when the operator names C9 or asks about retries, reliability, recovery, or failure handling.
---

# Canonical Claude Workflow Bridge

Read `.claude/skills/council/c9-reliability-recovery/SKILL.md` completely from the workspace root before acting, including every reference it routes for the task. That canonical skill body is the full workflow; this Codex entrypoint does not summarize, trim, or replace it. Resolve its relative references from the canonical skill directory.
