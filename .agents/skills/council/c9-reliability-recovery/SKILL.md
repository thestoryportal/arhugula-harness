...
| `harness.breaker.model_version` | string | **s13 §4.10 (e)** | Specific model version (e.g., `Codex-sonnet-4-7-20251215` vs. `Codex-sonnet-4-6-20250514`). Lets C10 distinguish capability mismatches between model versions; composes with s11 §4.1 judge-drift discipline |  
