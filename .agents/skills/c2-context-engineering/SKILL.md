...
description: Use when the operator names C2 or asks about within-turn context engineering and prompt state.
---

# Canonical Claude Workflow Bridge

Read `.claude/skills/council/c2-context-engineering/SKILL.md` completely from the workspace root before acting, including every reference it routes for the task. That canonical skill body is the full workflow; this Codex entrypoint does not summarize, trim, or replace it. Resolve its relative references from the canonical skill directory.
