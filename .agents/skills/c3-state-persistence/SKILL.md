...
description: Use when the operator names C3 or asks about state, memory, persistence, checkpoints, or recovery.
---

# Canonical Claude Workflow Bridge

Read `.claude/skills/council/c3-state-memory-persistence/SKILL.md` completely from the workspace root before acting, including every reference it routes for the task. That canonical skill body is the full workflow; this Codex entrypoint does not summarize, trim, or replace it. Resolve its relative references from the canonical skill directory.
