---
name: bmad-agent-pm
description: Use when the user asks for the product manager, PRD discovery, or John the PM.
---

# Canonical Claude Workflow Bridge

Read `.claude/skills/bmad-agent-pm/SKILL.md` completely from the workspace root before acting, including every reference it routes for the task. That canonical skill body is the full workflow; this Codex entrypoint does not summarize, trim, or replace it. Resolve its relative references from the canonical skill directory.
