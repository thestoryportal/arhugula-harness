...
|---|---|---|
| `Spec_Action_Surface_v1.md` | **v1.14 — canonical HEAD** — full per-version lineage relocated to `.harness/artifact-pointers/as.md` §1.2 axis archive (loaded on demand only; not part of the default session-start read path) | Contract authority — 16 contracts C-AS-01 through C-AS-16 |
| `Implementation_Plan_Action_Surface_v1_6.md` | **v1.6 — canonical HEAD** — full per-version lineage relocated to `.harness/artifact-pointers/as.md` §1.2 axis archive (loaded on demand only; not part of the default session-start read path) | Execution authority — 33 atomic units across 16 contracts and 9 topological levels (L0–L8) |
