...
|---|---|---|
| `Spec_Information_Substrate_v1.md` | **v1.11 — canonical HEAD** (in-place delta chain; v1.11 = 2026-07-19 B-48 apply arc — C-IS-07 §7.1 timestamp-authority row + NEW §7.6 writer-owned drain-path sampling inside `_WRITE_LOCK`, clearance `spec-information-substrate-v1-11-cleared-2026-07-19.md`; this row's prior `v1.8` pin was stale — refreshed; per-version detail at the spec's own change-notes) | Contract authority — the `C-IS-*` contract family (see the canonical spec for the full enumeration) |
