...
CP terminal aggregate exporters: U-CP-54 + U-CP-55 (per C-CP-24 §24). 12 OD→CP edges consume CP export surfaces. Per-edge enumeration at `Cross_Axis_Composition_Document_v2_17.md` §2.3.6.

### 2.3 Cross-axis edge inventory (CXA v2.17)

| Edge direction | Edges | Source artifact |
|---|---|---|
| CP → IS (outbound) | 43 | `Cross_Axis_Composition_Document_v2_17.md` §2.3.2 (was 37 at v2.9-v2.16; v2.17 absorbs 6 NEW Pattern-P1 typed seams at rows 38-43 for U-CP-74..U-CP-79 §16.5 composer atomic-unit LANDED events at PRs #39-#44 2026-05-28..29 per CP spec v1.25 §16.5.3 contract); `Implementation_Plan_Control_Plane_v1.md` §3.3 |
...
| OD → CP (inbound) | 12 | `Cross_Axis_Composition_Document_v2_17.md` §2.3.6 (was v2.1 §2.3.3 — bucket renumbered at v2.3 reclassification) |
