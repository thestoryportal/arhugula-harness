...
- The workspace `CLAUDE.md` owns project framing, the canonical authority chain (§1.3), citation byte-exact discipline (`Project_Workflow_v1_8.md` §7.4), and execution invariant I-1 (citations resolve byte-exact). The spec-writer operates under that framing.
...
- The governing artifacts up the authority chain (`CLAUDE.md` §1.3: ADR → ADD → PRD → spec) for any back-reference the fix touches.
...
- **Citation byte-exact** — every citation the fix introduces or touches resolves byte-exact (`CLAUDE.md` I-1; `Project_Workflow_v1_8.md` §7.4.2).
