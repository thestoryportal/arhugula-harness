...
R-CXA-2-cp-is-seam:
  ...
  notes: >
    ...
    **2026-06-08 producer-seam DESIGN SPEC filed** — `.harness/r-cxa-1-2-producer-seam-spec.md` §3–§4 specs the
    ...
    v2.39 Reading B). No new ADR (decisions are spec/plan-granularity; native mechanism = the fork docs); no PRD
    (internal architecture); impl plan deferred to post-ratification. Producer gaps now SPECIFIED-not-implemented.
    STAYS STILL-BOUNDED.
