...
Plan-vs-spec note. The §9.2 always-sampled exception set (20 rows — the first
18 landed at U-OD-11, row 19 at U-OD-58, row 20 at the `B-137` C1 leg) is
enumerated by namespace and does not contain a literal
