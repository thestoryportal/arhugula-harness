...
**OD-axis cumulative post-batch-34 (2026-05-28):** **3 / 8 RETIRED (37.5%, OD-2 GenAI binding + OD-5 cost-attribution 5-step chain + OD-8 authoring-close)** + **1 / 8 RETIRE-READY (12.5%, OD-6 sqlite-write-path 4-OD-B cluster wired; deployment-time-opt-in-gate terminal in-CLI state)** + **1 / 8 PARTIAL (12.5%, OD-3 composite sampler SDK-boundary wired; tail-keep + persona-envelope gates RETIRE-READY)** + **3 / 8 STILL-BOUNDED (37.5%, OD-1 + OD-4 + OD-7)**. Pipeline advanced (R+RR+P): **5/8 = 62.5%** (+1 net advancement from batch-32 via OD-3 STILL-BOUNDED → PARTIAL at batch-34; OD-6 PARTIAL → RETIRE-READY at batch-33 is within-tier).
...
**STILL-BOUNDED → PARTIAL gates (OD-1 + OD-4 + OD-7):**
