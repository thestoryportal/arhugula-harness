...
| S1 | `systems-architect` C-AS-02 spec-gap reconciliation analysis — output `.harness/s1_c_as_02_reconciliation.md` | 🟡 RUNNING (launched 2026-05-15) — recommends the canonical `sandbox_tier_floor` signature; operator decides; `spec-writer` then applies the C-AS-02 §2.2/§2.3/§11.1 fix |
