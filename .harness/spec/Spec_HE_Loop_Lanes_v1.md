...
Path: `.harness/spec/Spec_HE_Loop_Lanes_v1.md` · Date: 2026-08-18 · **v1.8** (execution-correction change-notes X1 2026-08-18 + X2 2026-08-19 + X3 2026-08-19 + X4a–X4d 2026-08-20 + X5 2026-08-25 + X6a–X6f 2026-08-26 + X7 2026-09-02 + X8 2026-09-18; marker `spec-he-loop-lanes-v1.8-cleared-2026-09-18.md`) · Repo at `17011f89c` (all `file:line` cites are pinned to this commit) · Namespace `C-HE-*` (H_E dev tooling; see §0.2)
...
| C-HE-21 / 22 | `.claude/skills/merge-gate/SKILL.md`, `ship-pr/SKILL.md` (live-carrier cites, no round cap) — doc; **NEW** `tools/reviewer_concurrency_probe.py`; `tools/review_loop_gate.py` + `tools/round_log_publish.py` + the launch step in `roadmap-continue/SKILL.md` (v1.6 X6b admission guard + per-attempt log names) |
