...
|---|---|---|---|---|---|
| A-1 | ~~closed~~ | ~~R-700 Phase-8 substitution review + final integer ratification~~ | Phase 8 declared closed at 46/54 retired + 49/54 pipeline-advanced; batch-52 live ledger now reports 49/54 + 52/54 | `R-700-phase-8-substitution-accounting` RESOLVED; batch-52 | no (AUQ) |
...
- **Current state.** CLOSED. The operator lifted the hold and Phase 8 was declared closed on 2026-06-02 at 46/54 RETIRED and 49/54 pipeline-advanced. Batch-52 is a forward live-ledger supersession, not a rewrite of that declaration: R-810/R-820 evidence moves AS-8e, AS-8f, and CP-17 to RETIRED, so the live ledger now reports 49/54 RETIRED and 52/54 pipeline-advanced.
