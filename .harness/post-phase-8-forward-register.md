...
| B-5 | ~~R-420 closed~~ / **[proposed] R-421** | V Deployment | SELF_HOSTED_SERVER + MANAGED_CLOUD e2e (R-420/R-421) | **R-420 RESOLVED by local single-node self-hosted daemon + collector + keyring live e2e; R-421 still deferred/operator-gated** | this PR + future cloud | ⚖️ (R-421) |
