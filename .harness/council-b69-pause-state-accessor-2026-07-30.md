...
| §9 row 1's contract-number choice (*left to the spec-writer*) | **NEW `C-RT-36` at NEW §31**, not a §14.14.9 sibling — §14.14.x is C-RT-24 internal-composition territory; this is a caller-facing package-root API, the second member of C-RT-35 §30's class. `:680`'s "no new operation" framing is the discriminator |
