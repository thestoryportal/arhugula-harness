...
Canonical at `design-substrate/Spec_Harness_Runtime_v1.md` v1.10 §15 (Spec-to-plan traceability) — coverage matrix mapping every U-RT-NN unit to ≥1 C-RT-NN contract, including per-bucket C-RT-12 §12.1–§12.6 rows, the C-RT-14 cross-cutting row, the v1.2-introduced U-RT-52 row (C-RT-15), the v1.4-introduced U-RT-58 row (C-RT-16), the v1.6-introduced U-RT-59 row (C-RT-17), and the v1.9-introduced U-RT-60 row (C-RT-18; v1.10 refinements are narrative-only within C-RT-18 §14.8.3 — §15 row preserved verbatim).
