...
- Gates: pyright 0/0/0 · ruff · harness-cp 1085 passed + 1 xfailed · runtime bootstrap/types 305 passed · decorrelated review advisor (substrate-fork + skew rule + §1.1) + out-of-family Codex (pre-merge).
