...
| u-sr-07 | `ec486d066` p1 | `61d47aac0` | false | false | 0 | 0 |
...
Window: 6 of 20 would skip; 0 findings in the window at all (the lens's last finding row predates it). The saving Task 6 Step 6 buys is therefore one subagent in roughly 6 of 79 gate rounds (9 of 79 with the `.harness/**` exclusion, at the cost of one measured miss).
