...
| U-CP-04 | Routing manifest residence — **SKIPPED** (Class 1: Pattern-D undeclared `RoleRoutingBinding`/`WorkloadRoutingOverride`/`RetryPolicy`; `.harness/class_1_tension_cp_batch_blocked_units_2026_05_16.md`) | C-CP-01 §1.3 | 🛑 skipped | — | 2026-05-16 |
| U-CP-05 | Layered routing strategy — **SKIPPED** (Class 1: `InferenceRequest` from unlanded U-CP-03; dep U-CP-04 blocked) | C-CP-02 §2.1+§2.2 | 🛑 skipped | — | 2026-05-16 |
