...
| Field | Value |
|---|---|
| `workspace_state_hash` | `485635e5d818` |
| `last_refreshed` | 2026-07-15T00:00:00Z |
| `git_head` | `47393453` — B-35 closed (qa-evidence-matrix + closure-gate CI orphan gap) + B-40 filed (memory ledger cross-process race, pre-existing, out of scope). |
