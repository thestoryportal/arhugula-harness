...
**Version scoping — interim window CLOSED (opened 2026-07-28 at the `B-86` spec
leg; closed 2026-07-28 at the U-MEM-26 impl leg).** This packet now certifies the
...
re-opened and extended above, no matrix row carries a `PENDING` marker, and the check was
re-run green with the refreshed rows in place — the plan's own closure condition
for the unit (acceptance items at `Implementation_Plan_Memory_Substrate_v1.md`
`:901` and `:924`). The impl-leg record is at
`.harness/u-mem-26-impl-leg-close-2026-07-28.md`.
