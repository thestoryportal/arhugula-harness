...
| `implementation-plan-he-loop-lanes` | `v1.0 + rev 2026-09-18 (U-HE-45 as-built plan record — Unit-status paragraph plus the Step 3 tick ONLY; Step 1–2 stays unticked because its --next-action half was not performed; no step text, scope sentence, contract number, row label or ordering changes)` | 2026-09-18 | `.harness/plan/Implementation_Plan_HE_Loop_Lanes_v1.md` | 22 | `implementation-plan-he-loop-lanes-v1-u-he-45-as-built-record-cleared-2026-09-18.md` |
| `spec-he-loop-lanes` | `v1.10` | 2026-09-19 | `.harness/spec/Spec_HE_Loop_Lanes_v1.md` | 11 | `spec-he-loop-lanes-v1.10-cleared-2026-09-19.md` |
