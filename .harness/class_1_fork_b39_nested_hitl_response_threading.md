...
**Status:** 🔵 PROPOSING (fresh fork, this session — 2026-07-23). No code changes accompany this doc; it is the X-AL-3-required design step the B-39 forward-register row (`.harness/forward-register.yaml`, re-grounded 2026-07-15) explicitly prescribes before any implementation: *"a Class 1 fork proposing the threading mechanism is the correct next step, before any code, per X-AL-3."*
