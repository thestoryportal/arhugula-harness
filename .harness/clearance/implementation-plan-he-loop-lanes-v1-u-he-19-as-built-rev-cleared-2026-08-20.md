...
reviewer_chain:
  ...
  - "out-of-family review + merge-gate lenses run on the landing PR per the standing S-step ritual (recorded in the PR body): 22 codex rounds to the register-and-hold terminal state, plus 3-lens merge-gate rounds whose fixes are enumerated at rev items vi-xii"
