...
reviewer_chain:
  ...
  - out-of-family `just codex-review` on this PD-8 promotion's own PR, pre-merge, TWO rounds — round 1 caught the audit-window misattribution + overstated independent-arc cardinality; round 2 caught round 1's own new errors (PR #972's axis mischaracterized, its probe count uncorrected) — all 4 corrected before merge, see Notes
