...
v1.36 is the OD-owned leg of the RATIFIED **B-69 durable-pause-state read accessor arc**. It carries exactly ONE new section — **§C-OD-30.5** — declaring the observability home for the two events the council's §6.5 ruled REQUIRED: the C-RT-36 §31 accessor read, and a `resume()` refused on the §30 staleness precondition.
