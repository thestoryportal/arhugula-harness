...
reviewer_chain:
  ...
  - out-of-family codex review (round 1, `just codex-review` base=main) — [P1] this row's first draft understated its own scope, naming only the counting/carrier side and omitting the delivery-cell construction required to actually consume the resolved response at the fan-out dispatch sites; fixed before merge
supersedes: null
---
