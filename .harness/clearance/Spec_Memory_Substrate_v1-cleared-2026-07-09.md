...
# Clearance — C-MEM-* contract family for the provider-neutral memory layer

Records the operational acceptance, for Phase-7 consumption, of `design-substrate/Spec_Memory_Substrate_v1.md`
