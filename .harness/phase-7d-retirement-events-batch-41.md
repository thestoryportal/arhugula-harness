...
> **Successor cardinality reconciliation (filed batch-41 successor doc-hygiene arc 2026-05-28):** Per ledger v2 §11.1a CXA-5 RETIRED-at-batch-3 supersession + operator-ratified adoption at workspace level — corrective workspace cumulative counts post-batch-41 are **43/54 RETIRED (79.6%) + 2 RETIRE-READY (3.7%) + 3 PARTIAL (5.6%) + 4 STILL-BOUNDED (7.4%) + 2 STILL-BOUNDED-INDEFINITELY (3.7%) = 54 ✓**. Pipeline-advanced: **48/54 = 88.9%**. The pre-supersession count in this batch footer (42 RETIRED + 5 STILL-BOUNDED) reflected the inherited stale ledger v2 §7 CXA-5 STILL-BOUNDED-DOWNSTREAM line carried since batch-3 (8-day carry-window propagated through every batch cardinality check). Forward-only ledger discipline preserved at this batch record per workspace `CLAUDE.md` §4.3; corrective accounting applies at batch-41 successor onward.
