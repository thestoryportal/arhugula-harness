...
async function runWrap({ tmp, scriptsDir, id, count, classes, tag, elementId, text, pageUrl, file }) {
  ...
  // Pin wrap to the target file so it does not roam to a sibling file that
  // shares the element (live.md: "pass --file PATH to skip the search").
