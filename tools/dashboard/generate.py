...
ANNOTATIONS = {
    ...
    "R-411-sandbox-tier-3-microvm-execution": "Next sandbox lane is host-fit provider selection: gVisor/Kata/Shuru/Microsandbox readiness probes decide what can run.",
    "R-412-sandbox-tier-4-full-vm-execution": "Deferred until managed cloud exists; Firecracker needs a Linux KVM host with /dev/kvm.",
...
REMAINING_ORDERED = [
    ...
    },
    {
        ...
        "gate": "R-411 needs a compatible local sandbox runtime; this macOS x86_64 host does not satisfy the current candidates.",
    },
    {
        "n": 11,
        "layer": "activation",
