...
ANNOTATIONS = {
    ...
    "R-430-otlp-collector-tail-keep-preservation": "Confirm the telemetry keep-rule works against the real collector now available from the R-420 local stack.",
...
REMAINING_ORDERED = [
    ...
    },
    {
        ...
        "layer": "activation",
        "id": "R-430",
        "label": "Collector tail-keep validation",
        "gate": "R-420 now provides the local real-collector substrate; verify classification-trigger spans survive tail-drop.",
    },
    {
        "n": 10,
        "layer": "activation",
        ...
        "gate": "R-411 needs a compatible local sandbox runtime; this macOS x86_64 host does not satisfy the current gVisor/Kata/Shuru/Microsandbox/libkrun candidates.",
    },
    {
        "n": 11,
        "layer": "activation",
