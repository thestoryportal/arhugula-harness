#!/usr/bin/env bash
# Hermetic test for the loop-control wrappers (U-HK-14/15): tools/loop/defer.sh +
# tools/loop/halt.sh. These are the allowlisted, single-invocation entry points the
