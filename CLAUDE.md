...
| Runtime | `Spec_Harness_Runtime_v1.md` (v1.14 — Path β citation reconciliation: §14.6 inner-attempt-span cited identifier `harness_cp.validator_fail_taxonomy.ValidatorFailClass` → `...ValidatorRetryExitClass` per Class 1 fork resolution at `.harness/class_1_fork_u_cp_58_validator_fail_class_collision.md` (2026-05-21); v1.13 NEW §14.9 + §14.10 contracts preserved verbatim) |
...
| Runtime | `Implementation_Plan_Harness_Runtime_v2_11.md` | 71 units (U-RT-00..U-RT-70); v2.10 prior + v2.11 — Remaining-Work Closure Arc Phase C absorption: NEW L9-sexies cluster (8 units U-RT-63..70) materializing C-RT-19 RuntimeToolDispatcher + MCPClientHost (STDIO+HTTP+SSE) + C-RT-20 WebhookDeliveryComposer + OperatorBurdenEvaluator (2026-05-21) |
