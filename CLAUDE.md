...
| Runtime | `Spec_Harness_Runtime_v1.md` (v1.13 — Remaining-Work Closure Arc Phase B iteration-2 absorption: NEW §14.9 C-RT-19 RuntimeToolDispatcher + MCPClientHost + STDIO/HTTP/SSE transport-neutral terminology (F2-01) + NEW §14.10 C-RT-20 WebhookDeliveryComposer + OperatorBurdenEvaluator (2026-05-21)) |
...
| CP | `Implementation_Plan_Control_Plane_v2_15.md` | 73 units (U-CP-00, U-CP-00b, U-CP-00c, U-CP-01 – U-CP-72); v2.14 prior absorptions preserved; v2.15 — Remaining-Work Closure Arc Phase C absorption: NEW Cluster 10 (15 units U-CP-58..72) materializing C-CP-25 ValidatorFramework + C-CP-26 PauseResumeProtocol + C-CP-27 PerServerTrustEvaluator + MCPClientNamespaceEmitter + §17.4 hitl_gate signature + cp_audit_to_od_audit converter +6 prefixes (2026-05-21) |
...
| CXA | `Cross_Axis_Composition_Document_v2_6.md` | canonical cross-axis relationships per v2.6 (Closure Arc Phase A absorption, 2026-05-21); v2.5 prior preserved (§2.3.7 CP→OD bucket with 2 typed seams via `cp_audit_to_od_audit` converter at `harness-cxa/`); §2.3.7 row 8 cost-attribution audit-write seam owed at v2.7 amendment (paired with U-CP-72 implementation per handoff §6) |
