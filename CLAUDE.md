...
Canonical spec heads are IS `Spec_Information_Substrate_v1.md`, AS `Spec_Action_Surface_v1.md` (v1.10), CP `Spec_Control_Plane_v1_37.md`, OD `Spec_Operational_Discipline_v1_28.md`, and Runtime `Spec_Harness_Runtime_v1.md` (v1.51). Full per-spec lineage is indexed at `claude-artifact-pointers.md` §2.3 in `.harness`.
