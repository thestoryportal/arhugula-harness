...
| CP | `Spec_Control_Plane_v1_10.md` (v1.10 — Remaining-Work Closure Arc Phase A.2 absorption: NEW §25 C-CP-25 ValidatorFramework + NEW §26 C-CP-26 PauseResumeProtocol + NEW §27 C-CP-27 PerServerTrustEvaluator + MCPClientNamespaceEmitter + §17.4 hitl_gate canonical signature (2026-05-21); v1.9 Form A NOTE-absorption preserved) |
| OD | `Spec_Operational_Discipline_v1_8.md` (v1.8 — Remaining-Work Closure Arc Phase A.2 absorption: NEW §C-OD-25 WorkflowEnvelopeSpan + NEW §C-OD-26 cost-attribution invocation contract + NEW §C-OD-27 PRICE_TABLE_REF rate-table substrate + NEW §C-OD-28 RateTable types + NEW §C-OD-29..33 canonical schemas (validator / pause_resume / mcp.trust / hitl.webhook / hitl.operator_burden) (2026-05-21); v1.7 Form A NOTE state-transition preserved) |
...
| CP | `Implementation_Plan_Control_Plane_v2_16.md` | 73 units (U-CP-00, U-CP-00b, U-CP-00c, U-CP-01 – U-CP-72); v2.15 prior absorptions preserved; v2.16 — Path β citation reconciliation absorption: U-CP-47 plan-body `enum ValidatorFailClass` → `enum ValidatorRetryExitClass` rename per Class 1 fork resolution at `.harness/class_1_fork_u_cp_58_validator_fail_class_collision.md` (2026-05-21); member values + DAG + coverage preserved verbatim |
| OD | `Implementation_Plan_Operational_Discipline_v2_14.md` | 55 units (U-OD-00, U-OD-01 – U-OD-54); v2.13 prior absorptions preserved; v2.14 — Remaining-Work Closure Arc Phase C absorption: NEW Cluster 4 (20 units U-OD-35..54) — 4-OD-A WorkflowEnvelope (3) / 4-OD-B sqlite (4) / 4-OD-C rate-table (4) / 4-OD-D cost-attribution (4) / 4-OD-E canonical schemas (5) (2026-05-21) |
...
| CXA | `Cross_Axis_Composition_Document_v2_7.md` | canonical cross-axis relationships per v2.7 (path-β citation reconciliation 2026-05-21); v2.6 cardinality preserved (99 aggregate / 29 genuine / 46 convention / 24 phase-2-runtime); v2.7 amendment scope: §0.11 promotion-candidate row 1 citation `harness_cp...ValidatorFailClass` → `...ValidatorRetryExitClass`; §2.3.7 row 8 cost-attribution audit-write seam still owed at future v2.8 amendment (paired with U-CP-72 implementation per handoff §6) |
