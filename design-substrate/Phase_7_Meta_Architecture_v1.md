...
| Version | v1.3 |
| Status | **Proposed (v1.3)** — Phase 7b in-CLI revision absorbing single-row H_T-CP-19 amendment from sibling Class 1 fork `.harness/class_1_fork_meta_arch_cp_spec_renumbering_drift.md` §12.3 ratified disposition (operator-ratified union cite shape `U-CP-26 + U-CP-27 + U-CP-43` per material-location-resident reading §5.1.1, 2026-05-23). H_T-CP-15/16/17 amendments DEFERRED at this arc per new sibling Class 1 fork `.harness/class_1_fork_meta_arch_section_2_2_as_axis_carrier_phantom_cites.md` — spec-writer FM-1 + FM-3 HALT surfaced during empirical verification of §12.3 cite shapes (§2.2 H_T-AS-6/7 carrier-cite phantom recurrence). v1.2 substantive content preserved verbatim outside the 3 amendment sites enumerated at new §0.3. v1.1 substantive content preserved verbatim outside v1.2 §0.2 amendment sites. v1 substantive content preserved verbatim outside v1.1 §0.1 amendment sites. |
| Date | 2026-05-23 (v1.3); 2026-05-23 (v1.2); 2026-05-23 (v1.1); 2026-05-15 (v1) |
...
| H_T-CP-20 | `AskUserQuestion` tool + permission-prompt approval; no 4-response palette; no `hitl.*` / `audit.*` namespaces | Covers: HITL invocation surface. Does NOT cover: 4-response palette (APPROVE / APPROVE_WITH_NOTE / DEFER / REJECT); namespace emission | U-CP-37 + U-CP-38 + U-CP-39 + U-CP-46 [v1.2 augmentation per fork doc §10.4 — palette declaration (U-CP-37) + placement (U-CP-38) + tool-call rewriting (U-CP-39) + audit/hitl emission (U-CP-46); consistent with batch-9 RETIRED filing implicit cite surface] |
| H_T-CP-21 | Operator reviews every sub-agent output before commit; no automated validator framework; operator-burden via manual ledger annotation | Covers: human-mediated validation gate. Does NOT cover: 5-class ValidatorFailClass; transient staircase; cause-branching; operator-burden eval primitive | U-CP-47 + U-CP-48 + U-CP-51 [v1.2 — U-CP-52 STRUCK per §5.8 audit; mis-cited (HITL webhook not validator)] |
...
| **H_T-CP-21** | ValidatorFailClass 5-class + transient staircase + cause-branching + operator-burden eval | U-CP-47 + U-CP-48 + U-CP-51 + ~~U-CP-52~~ (v1.2 strike) | U-CP-47 / U-CP-48 / U-CP-51 verify clean against current spec surface; U-CP-52 was mis-cited (HITL webhook/timeout, not validator) | **RESOLVED at v1.2 — see §0.2 Site 3 + Site 5** | Strike per fork doc §10.4 + operator-ratified PER-ROW-RATIFY priority-3 disposition 2026-05-23. Anchor cite at §2.3 augmented to `C-CP-21 §21 + C-CP-25 §25` (NEW C-CP-25 ValidatorFramework at CP spec v1.10). §5.4 + §2.3 carrier cites strike U-CP-52. H_T-CP-21 remains STILL-BOUNDED; v1.2 cite shape unblocks future retirement filing arc against augmented Validator surface. |
...
| Phantom — full row | 2 | H_T-CP-16, H_T-CP-17 [v1.3 — H_T-CP-19 RESOLVED at v1.3 per sibling fork §12.1 tiebreaker; this row count and member list amended from v1.1 baseline] | Operator-decision-owed; H_T-CP-16/17 DEFERRED at v1.3 per new sibling fork `.harness/class_1_fork_meta_arch_section_2_2_as_axis_carrier_phantom_cites.md` (§2.2 H_T-AS-6/7 carrier-cite recurrence); HALT retirement filings until §2.2 systems-architect re-recommendation arc lands |
