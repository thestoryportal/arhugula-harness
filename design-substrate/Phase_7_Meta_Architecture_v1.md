...
| Version | v1.2 |
| Status | **Proposed (v1.2)** — Phase 7b in-CLI revision absorbing Class 1 fork `.harness/class_1_fork_meta_arch_cp_spec_renumbering_drift.md` §10 systems-architect recommendation (operator-ratified PER-ROW-RATIFY priority-3 dispositions 2026-05-23) — 3 §2.3 row re-anchors (H_T-CP-18 / H_T-CP-20 / H_T-CP-21) + 2 §5.4 row augmentations (H_T-CP-20 / H_T-CP-21) + §5.8 disposition updates for the 3 priority rows. v1.1 substantive content preserved verbatim outside the 6 amendment sites enumerated at new §0.2. v1 substantive content preserved verbatim outside v1.1 §0.1 amendment sites. |
| Date | 2026-05-23 (v1.2); 2026-05-23 (v1.1); 2026-05-15 (v1) |
