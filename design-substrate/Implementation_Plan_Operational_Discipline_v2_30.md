...
**Tests (mutation-probed per Workflow v1.18 PD-8):** the 6 NEW witnesses at criteria #5–7 above, plus criterion #8's non-regression re-run, plus criterion #9's disclosure witness.
