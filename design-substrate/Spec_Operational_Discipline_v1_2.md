...
| Status | **Proposed** — Phase 5 session 4 axis specification; no clearance until aggregate P5-CK per `Project_Workflow_v1_2.md` §2.5.1 + OD-5-4.A |
| Date | 2026-05-13 |
...
| D4 | v1.1 | Secondary (citation only) — `topology.fanout.*` + `subagent.*` namespaces source per §1.9; declared at C-CP-14 |
...
| 7 | `topology.fanout.*` | ADR-D4 v1.1 §1.9; declared at C-CP-14 §14.2 | included in C-CP-14 §14.2 topology.* attribute set | C-CP-14 §14.2 | Ingest verbatim |
