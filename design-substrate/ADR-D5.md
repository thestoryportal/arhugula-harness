...
Revision date: 2026-05-20 (v1.4 — Phase-7 in-CLI per workspace `CLAUDE.md` §4.3; design-phase back-flow deprecated 2026-05-15 per `[[design-substrate-divergence]]`)
...
**Status posture.** `Status: Accepted` preserved per the v1 + v1.1 + v1.2 + v1.3 promotion-path chain.
